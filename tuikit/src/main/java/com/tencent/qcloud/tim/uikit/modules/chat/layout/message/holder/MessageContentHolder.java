...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    private final TIMUserProfile mSelfInfo = TuiKitApplication.instance().getSelfInfo();;
...
//            rightUserIcon.setDefaultImageResId(R.drawable.default_user_icon);
        ...
        if (profile == null) {
            ...
            leftUserIcon.setNetView(profile.getFaceUrl());
            usernameText.setText(!TextUtils.isEmpty(profile.getNickName()) ? profile.getNickName() : msg.getFromUser());
        }
        //将获取到服务器的个人头像设置到聊天列表中
        if (mSelfInfo != null && !TextUtils.isEmpty(mSelfInfo.getFaceUrl()))
            rightUserIcon.setNetView(mSelfInfo.getFaceUrl());
