...
public class TitleBarLayout extends LinearLayout implements ITitleBarLayout {
    ...
    private void init() {
        ...
        mTitleLayout.setBackgroundColor(getResources().getColor(R.color.app_theme_color));
    }
    ...
    @Override
    public void setRightIcon(Drawable pDrawable) {
        mRightIcon.setImageDrawable(pDrawable);
    }
