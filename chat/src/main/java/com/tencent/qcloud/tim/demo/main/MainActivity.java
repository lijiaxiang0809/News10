...
public class MainActivity extends Activity implements ConversationManagerKit.MessageUnreadWatcher {
    ...
    private Drawable mConversationSelectedDrawable;
    private Drawable mContactSelectedDrawable;
    private Drawable mMyselfSelectedDrawable;
    ...
    private void changeTabColor() {
        mConversationSelectedDrawable = ChangeColorUtil.changeDrawableColor(this, R.drawable.conversation_selected,R.color.app_theme_color);
        mContactSelectedDrawable = ChangeColorUtil.changeDrawableColor(this, R.drawable.contact_selected,R.color.app_theme_color);
        mMyselfSelectedDrawable = ChangeColorUtil.changeDrawableColor(this, R.drawable.myself_selected,R.color.app_theme_color);
    }
    ...
    private void initView() {
        ...
        mConversationBtn.setCompoundDrawablesWithIntrinsicBounds(null,mConversationSelectedDrawable, null, null);
    ...
    public void tabClick(View view) {
        ...
        if (i == R.id.conversation_btn_group) {
            ...
            mContactBtn.setCompoundDrawablesWithIntrinsicBounds(null, mContactSelectedDrawable, null, null);
            ...
            mProfileSelfBtn.setCompoundDrawablesWithIntrinsicBounds(null,mMyselfSelectedDrawable, null, null);
