...
public class MatchInnerInfo {
    ...
    public static class TeamerInfo{
        public String match_id;
        public TeamerA sts_A;
        public TeamerB sts_B;
        public static class TeamerA{
            public String name;
            public String logo;
            public String tips;
        }
        public static class TeamerB{
            public String name;
            public String logo;
            public String tips;
        }
